...
export default function CreateContest() {
  ...
  useEffect(() => {
    setHeader(prev => {
      if (prev?.title === 'Создание конкурса' && prev?.avatar === avatars?.female) return prev;
      return { title: 'Создание конкурса', avatar: avatars?.female };
    });
  }, [setHeader, avatars]);
    ...
    <div className={styles.page}>
      ...
      >
        ...
        <div className={styles.footer}>
          <button type="submit" className={styles.btnPrimary}>Ок</button>
